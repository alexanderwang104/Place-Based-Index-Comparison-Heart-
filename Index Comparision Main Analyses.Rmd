...
save_df_as_html(svm_tidy_un, "svm_table_un.html")
save_df_as_html(svi_tidy_un, "svi_table_un.html")
save_df_as_html(adi_tidy_un, "adi_table_un.html")
save_df_as_html(dci_tidy_un, "dci_table_un.html")
save_df_as_html(svm_tidy_death_un, "svm_table_death_un.html")
save_df_as_html(svi_tidy_death_un, "svi_table_death_un.html")
save_df_as_html(adi_tidy_death_un, "adi_table_death_un.html")
save_df_as_html(dci_tidy_death_un, "dci_table_death_un.html")

save_df_as_html(svm_tidy_small, "svm_table_small.html")
save_df_as_html(svi_tidy_small, "svi_table_small.html")
save_df_as_html(adi_tidy_small, "adi_table_small.html")
save_df_as_html(dci_tidy_small, "dci_table_small.html")
save_df_as_html(svm_tidy_death_small, "svm_table_death_small.html")
save_df_as_html(svi_tidy_death_small, "svi_table_death_small.html")
save_df_as_html(adi_tidy_death_small, "adi_table_death_small.html")
save_df_as_html(dci_tidy_death_small, "dci_table_death_small.html")

save_df_as_html(svm_tidy_full, "svm_table_full.html")
save_df_as_html(svi_tidy_full, "svi_table_full.html")
save_df_as_html(adi_tidy_full, "adi_table_full.html")
save_df_as_html(dci_tidy_full, "dci_table_full.html")
save_df_as_html(svm_tidy_death_full, "svm_table_death_full.html")
save_df_as_html(svi_tidy_death_full, "svi_table_death_full.html")
save_df_as_html(adi_tidy_death_full, "adi_table_death_full.html")
save_df_as_html(dci_tidy_death_full, "dci_table_death_full.html")
