...
tbl2 <- svm_death |> tbl_regression(exponentiate = TRUE, label = list(
  ...
  svm_causespecific <- coxph(Surv(survival_time,transplant_outcome) ~ SVM_decile + can_race + ethnicity +  CAN_GENDER + CAN_AGE_AT_LISTING + durable_LVAD +temporary_LVAD + RVAD + TAH + LVAD_RVAD + initial_status, data = heart_SVM)


svm_death_causespecific <- coxph(Surv(survival_time,death_outcome) ~ SVM_decile + can_race + ethnicity +  CAN_GENDER + CAN_AGE_AT_LISTING + durable_LVAD +temporary_LVAD + RVAD + TAH + LVAD_RVAD + initial_status, data = heart_SVM)

tbl3<- svm_causespecific |> 
  tbl_regression(exponentiate = TRUE, label = list(
    SVM_decile ~ "SVM Decile",
    can_race ~ "Race",
    ethnicity ~ "Ethnicity",
  ...
  modify_header(label = "") 
tbl4 <- svm_death_causespecific |> tbl_regression(exponentiate = TRUE, label = list(
    SVM_decile ~ "SVM Decile",
    can_race ~ "Race",
    ethnicity ~ "Ethnicity",
    CAN_GENDER ~ "Sex",
...
svi_causespecific <- coxph(Surv(survival_time,transplant_outcome) ~ SVI_decile + can_race + ethnicity +  CAN_GENDER + CAN_AGE_AT_LISTING + durable_LVAD +temporary_LVAD + RVAD + TAH + LVAD_RVAD + initial_status, data = heart_SVM)

svi_death_causespecific <- coxph(Surv(survival_time,death_outcome) ~ SVI_decile + can_race + ethnicity +  CAN_GENDER + CAN_AGE_AT_LISTING + durable_LVAD +temporary_LVAD + RVAD + TAH + LVAD_RVAD + initial_status, data = heart_SVM)

tbl3<- svi_causespecific |> 
  tbl_regression(exponentiate = TRUE, label = list(
    SVI_decile ~ "SVI Decile",
    can_race ~ "Race",
    ethnicity ~ "Ethnicity",
  ...
  modify_header(label = "") 
tbl4 <- svi_death_causespecific |> tbl_regression(exponentiate = TRUE, label = list(
    SVI_decile ~ "SVI Decile",
    can_race ~ "Race",
    ethnicity ~ "Ethnicity",
    CAN_GENDER ~ "Sex",
...
tbl2 <- adi_death |> tbl_regression(exponentiate = TRUE, label = list(
  ...
  adi_causespecific <- coxph(Surv(survival_time,transplant_outcome) ~ ADI_decile + can_race + ethnicity +  CAN_GENDER + CAN_AGE_AT_LISTING + durable_LVAD +temporary_LVAD + RVAD + TAH + LVAD_RVAD + initial_status, data = heart_SVM)


adi_death_causespecific <- coxph(Surv(survival_time,death_outcome) ~ ADI_decile + can_race + ethnicity +  CAN_GENDER + CAN_AGE_AT_LISTING + durable_LVAD +temporary_LVAD + RVAD + TAH + LVAD_RVAD + initial_status, data = heart_SVM)

tbl3<- adi_causespecific |> 
  tbl_regression(exponentiate = TRUE, label = list(
    ADI_decile ~ "ADI Decile",
    can_race ~ "Race",
    ethnicity ~ "Ethnicity",
  ...
  modify_header(label = "") 
tbl4 <- adi_death_causespecific |> tbl_regression(exponentiate = TRUE, label = list(
    ADI_decile ~ "ADI Decile",
    can_race ~ "Race",
    ethnicity ~ "Ethnicity",
    CAN_GENDER ~ "Sex",
...
tbl2 <- dci_death |> tbl_regression(exponentiate = TRUE, label = list(
  ...
  dci_causespecific <- coxph(Surv(survival_time,transplant_outcome) ~ DCI_decile + can_race + ethnicity +  CAN_GENDER + CAN_AGE_AT_LISTING + durable_LVAD +temporary_LVAD + RVAD + TAH + LVAD_RVAD + initial_status, data = heart_SVM)


dci_death_causespecific <- coxph(Surv(survival_time,death_outcome) ~ DCI_decile + can_race + ethnicity +  CAN_GENDER + CAN_AGE_AT_LISTING + durable_LVAD +temporary_LVAD + RVAD + TAH + LVAD_RVAD + initial_status, data = heart_SVM)


tbl3<- dci_causespecific |> 
  tbl_regression(exponentiate = TRUE, label = list(
    DCI_decile ~ "DCI Decile",
    can_race ~ "Race",
    ethnicity ~ "Ethnicity",
  ...
  modify_header(label = "") 
tbl4 <- dci_death_causespecific |> tbl_regression(exponentiate = TRUE, label = list(
    DCI_decile ~ "DCI Decile",
    can_race ~ "Race",
    ethnicity ~ "Ethnicity",
    CAN_GENDER ~ "Sex",
...
avg_patient <- expand_grid(
  ...
  race = fct_unique(heart_SVM$can_race),
  status = fct_unique(heart_SVM$initial_status),
  ethnicity = fct_unique(heart_SVM$ethnicity),
  gender = fct_unique(heart_SVM$CAN_GENDER),
  age = median(heart_SVM$CAN_AGE_AT_LISTING),
  t_LVAD = seq(0,1),
  RVAD = seq(0,1),
  TAH = seq(0,1),
  LVAD_RVAD = seq(0,1))
